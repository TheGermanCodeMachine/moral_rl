...
def measure_quality(org_traj, counterfactual_trajs, counterfactual_rewards, starts, end_cfs, end_orgs, ppo, all_org_trajs, all_cf_trajs, all_starts, all_end_cfs, all_end_orgs):
    ...
    # qc_values = [(x, validity_qc[x] - proximity_qc[x] + critical_state_qc[x]) for x in range(len(counterfactual_rewards))]
    qc_values = [(x, validity_qc[x] - proximity_qc[x]) for x in range(len(counterfactual_rewards))]
    # qc_values = [(x, -critical_state_qc[x]) for x in range(len(counterfactual_rewards))]
